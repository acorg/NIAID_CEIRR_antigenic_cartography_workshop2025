...
This script contains tasks to construct antibody landscapes on top of antigenic maps. The solutions are 
available in `code/04_antibody_landscapes_solution.Rmd`. 
