...
Above, we have been using quite "unrealistic" simulated data. Now, we'll produce and style a map using more a titer table which looks more like something you might produce in practice, containing a selection of SARS-CoV-2 variants. We'll also use this map later on in the map diagnostics session.
