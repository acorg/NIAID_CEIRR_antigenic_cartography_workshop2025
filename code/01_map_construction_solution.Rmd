...
Read in the titer table, `data/01_sars_cov_2_titerdata.csv`":
```{r}
...
1. Set the fill color of the antigens, using the colors provided in `data/01_sars_cov_2_antigen_colors.RDS`:
```{r}
...
Read in the aligned spike nucleotide sequences from `../data/01_spike_sequences.fasta`:
```{r}
