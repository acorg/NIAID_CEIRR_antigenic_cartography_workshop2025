...
Working code is provided for each section in the file `03_troubleshooting_ex2_ag_reactivity_solution.Rmd`. We encourage you to try and write your own code here and to perform each task before runnning the provided code.
...
plot_titers = function(titers){
  ...
  mutate(
    antigen = factor(antigen, agNames(map)),
    serum_variant = factor(serum_variant, agNames(map)),
