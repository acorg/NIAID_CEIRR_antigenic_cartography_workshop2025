...
```{r load_packages}
# Package names
packages <- c("Racmacs","ggplot2", "dplyr", "knitr", "tidyverse")
...
We will be working with artifical titer data. 

Load the data from `data/01_titerdata.csv`:
...
```{r load_data}
titerdata <- read.csv("../data/01_titerdata.csv", row.names = "X")
```
