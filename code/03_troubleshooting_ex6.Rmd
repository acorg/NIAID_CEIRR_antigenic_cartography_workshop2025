...
Working code is provided for each section in the file [`03_troubleshooting_ex6_solution.Rmd`](./code/03_troubleshooting_ex6_solution.Rmd).. We encourage you to try and write your own code here and to perform each task before runnning the provided code.
